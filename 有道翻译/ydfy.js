...
// var appVersion = '5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36';
var appVersion = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36';
function get_param(e) {
        var t = _md5(appVersion)
          , r = "" + (new Date).getTime()
        ...
        return {
            ...
            bv: t,
            salt: i,
            sign: _md5("fanyideskweb" + e + i + "Y2FYu%TNSbMCxc3t2u^XT")
        }
    };

console.log(get_param('我爱你'))
